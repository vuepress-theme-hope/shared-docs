import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e}from"./app-103dd778.js";const t={},p=e(`<p>与内容相关的函数应该在 Node 侧被调用，你应该仅在 Node 端代码中从 <code>vuepress-shared/node</code> 导入它们。</p><h2 id="getpageexcerpt" tabindex="-1"><a class="header-anchor" href="#getpageexcerpt" aria-hidden="true">#</a> getPageExcerpt</h2><p>获取页面摘要</p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">interface</span> <span class="token class-name">PageExcerptOptions</span> <span class="token punctuation">{</span>
