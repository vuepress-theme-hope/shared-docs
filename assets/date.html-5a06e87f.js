import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e}from"./app-103dd778.js";const t={},o=e(`<h3 id="getdateinfo" tabindex="-1"><a class="header-anchor" href="#getdateinfo" aria-hidden="true">#</a> getDateInfo</h3><p>Get date info from a string or Date object.</p><div class="hint-container note"><p class="hint-container-title">Note</p><p>The function returns null instead of throw error when the date is invalid.</p></div><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">interface</span> <span class="token class-name">DateDetail</span> <span class="token punctuation">{</span>
