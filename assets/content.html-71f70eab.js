import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,e}from"./app-103dd778.js";const t={},p=e(`<p>Content related function be called at node side, you shall import them from <code>vuepress-shared/node</code> in node side code only.</p><h2 id="getpageexcerpt" tabindex="-1"><a class="header-anchor" href="#getpageexcerpt" aria-hidden="true">#</a> getPageExcerpt</h2><p>Get page excerpt.</p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">interface</span> <span class="token class-name">PageExcerptOptions</span> <span class="token punctuation">{</span>
...
<span class="token keyword">export</span> <span class="token keyword">const</span> <span class="token function-variable function">getPageExcerpt</span><span class="token operator">:</span> <span class="token punctuation">(</span>
  ...
  options<span class="token operator">:</span> PageExcerptOptions <span class="token operator">=</span> <span class="token punctuation">{</span><span class="token punctuation">}</span><span class="token punctuation">,</span>
